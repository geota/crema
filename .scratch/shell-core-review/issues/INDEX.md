...
| # | Title | Sev | Status |
|---|-------|-----|--------|
| 01 | Export `brew_ratio` via UniFFI + one 1-decimal ratio formatter everywhere | P1 | ready-for-agent |
...
| 09 | Add `roast_band5` to core + both bindings | P2 | ready-for-agent |
...
| 36 | Extract `CremaStarRating(...)` | P2 | ready-for-agent |
