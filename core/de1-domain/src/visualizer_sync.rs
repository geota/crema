...
pub struct VisualizerSyncPrefs {
    ...
    pub shots_direction: String,
    /// Beans sync direction. Web-driven; Android carries the default only. Default: two-way.
    pub beans_direction: String,
    /// Roasters sync direction. Web-driven; Android carries the default only. Default: two-way.
    pub roasters_direction: String,
}

impl Default for VisualizerSyncPrefs {
    fn default() -> Self {
        Self {
            auto_upload: true,
            auto_sync: true,
            privacy: "unlisted".to_owned(),
            include_profile: true,
            include_notes: false,
            shots_direction: "backup".to_owned(),
            beans_direction: "two-way".to_owned(),
            roasters_direction: "two-way".to_owned(),
        }
    }
}
