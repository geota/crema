 ...
 *
 * SPIKE B NOTE — this file is a *copy* of `core/bindings/crema-core.kt`, which
 * is itself generated by `core/generate-bindings.sh` (`typeshare`) from the
 ...
 *
 * Do not hand-edit. The real app should consume `core/bindings/crema-core.kt`
 * directly (e.g. via a shared module or a copy task) rather than vendoring it.
 */
