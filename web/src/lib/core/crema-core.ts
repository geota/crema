 ...
 *
 * Vendored from `crema/core/bindings/crema-core.ts`, which `typeshare` emits
 * from the Rust core's `#[typeshare]` types. Copied verbatim into the web
 * shell so `$lib` has a self-contained, type-checkable copy — exactly how the
 * Android shell vendors `CremaCoreTypes.kt`. To refresh: regenerate the core
 * bindings, then re-copy this file. Never hand-edit it.
 *
